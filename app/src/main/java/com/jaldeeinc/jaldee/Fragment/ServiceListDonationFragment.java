...
public class ServiceListDonationFragment extends RootFragment {

    public ServiceListDonationFragment() {
    ...
    ArrayList<SearchDonation> serviceList_Detail;
    TextView tv_subtitle;
    RecyclerView mrecycle_service;
    ServiceListDonationAdapter mAdapter;
    String from;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle != null) {
            ...
            if (from.equalsIgnoreCase("searchdetail")) {
                ...
                for(int i=0;i<serviceList.size();i++){
                    SearchDonation data = new SearchDonation();
        ...
        mAdapter = new ServiceListDonationAdapter(serviceList_Detail, mContext,from,title,uniqueid,getActivity());
