...
import com.jaldeeinc.jaldee.adapter.CheckIn_FamilyMemberListAdapterDonation;
...
public class CheckinFamilyMemberDonation extends AppCompatActivity {
    ...
    CheckIn_FamilyMemberListAdapterDonation mFamilyAdpater;
    TextView btn_add;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_changemem.setText("Back to Donation");
                ...
                if (multiple) {
                    ...
                    for (int i = 0; i < data.size(); i++) {
                        ...
                        if (i == data.size() - 1) {
                            ...
                            Donation.refreshMultipleMEmList(familyList);
                            finish();
                        }

                    }
                } else {
                    Donation.refreshName(s_changename, memberid);
                    finish();
                }
                    ...
                    if (response.code() == 200) {
                        ...
                        if (LuserProfileList.size() > 0) {
                            ...
                            if (update == 1 || multiple) {
                                ...
                                mFamilyAdpater = new CheckIn_FamilyMemberListAdapterDonation(btn_changemem, LCheckList, multiple, LCheckList, mContext, mActivity);
                            } else {
                                if (memID == 0) {
                                    memID = consumerID;
                                }
                                ...
                                Config.logV("memID @@@@@" + memID);
                                mFamilyAdpater = new CheckIn_FamilyMemberListAdapterDonation(btn_changemem, update, memID, multiple, LuserProfileList, mContext, mActivity);
                            }
