...
public class CheckinFamilyMemberAppointment extends AppCompatActivity {
    ...
    CheckIn_FamilyMemberListAdapterAppointment mFamilyAdpater;
    TextView btn_add;
                ...
                if (multiple) {
                    ...
                    for (int i = 0; i < data.size(); i++) {
                        ...
                        if (i == data.size() - 1) {
                            ...
                            Appointment.refreshMultipleMEmList(familyList);
                            finish();
                        }
                    ...
                    if (response.code() == 200) {
                        ...
                        if (LuserProfileList.size() > 0) {
                            ...
                            if (update == 1 || multiple) {
                                ...
                                mFamilyAdpater = new CheckIn_FamilyMemberListAdapterAppointment(btn_changemem, LCheckList, multiple, LCheckList, mContext, mActivity);
                            } else {
                                if (memID == 0) {
                                    memID = consumerID;
                                }
                                ...
                                Config.logV("memID @@@@@" + memID);
                                mFamilyAdpater = new CheckIn_FamilyMemberListAdapterAppointment(btn_changemem, update, memID, multiple, LuserProfileList, mContext, mActivity);
                            }
