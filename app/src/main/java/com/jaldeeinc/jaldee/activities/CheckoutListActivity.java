...
//                    Config.logV("zxczqw" + new Gson().toJson(response.body()));
                    ...
                    if (response.code() == 200) {
                        ...
                        if (walletEligibleJCash != null) {
                            if (catalogs.get(0).getAdvanceAmount() != null && !catalogs.get(0).getAdvanceAmount().isEmpty() && Float.parseFloat(catalogs.get(0).getAdvanceAmount()) > 0 && walletEligibleJCash.getjCashAmt() > 0) {
