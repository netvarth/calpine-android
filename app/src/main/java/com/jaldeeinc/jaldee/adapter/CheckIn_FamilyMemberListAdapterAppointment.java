...
import com.jaldeeinc.jaldee.activities.CheckinFamilyMemberAppointment;
...
public class
CheckIn_FamilyMemberListAdapterAppointment extends RecyclerView.Adapter<CheckIn_FamilyMemberListAdapterAppointment.MyViewHolder> {
    ...
    public CheckIn_FamilyMemberListAdapterAppointment(Button changemem,int update,int memId, boolean multiple, List<FamilyArrayModel> mfamilyList, Context mContext, Activity mActivity) {
    ...
    public CheckIn_FamilyMemberListAdapterAppointment(Button changemem,ArrayList<FamilyArrayModel> mCheckList, boolean multiple, List<FamilyArrayModel> mfamilyList, Context mContext, Activity mActivity) {
        this.mContext = mContext;
        this.familyList = mfamilyList;
        this.activity = mActivity;
        this.multiple = multiple;
    ...
    @Override
    public CheckIn_FamilyMemberListAdapterAppointment.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.radio_familytlist_row, parent, false);

        return new CheckIn_FamilyMemberListAdapterAppointment.MyViewHolder(itemView);
    }
    public int getItemViewType(int position) {
        return position;
    }
    @Override
    public void onBindViewHolder(final CheckIn_FamilyMemberListAdapterAppointment.MyViewHolder myViewHolder, final int position) {
        ...
        myViewHolder.name.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                CheckinFamilyMemberAppointment.changeMemberName(myViewHolder.name.getText().toString(), familylist.getId());
            }
        });
        ...
        myViewHolder.Checkmemeber.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                CheckinFamilyMemberAppointment.CheckedFamilyList(checkedfamilyList);
