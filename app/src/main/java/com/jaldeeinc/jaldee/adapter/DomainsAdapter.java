...
public class DomainsAdapter extends RecyclerView.Adapter<DomainsAdapter.ViewHolder> {
    ...
    public DomainsAdapter(Context context, ArrayList<KeyValue> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        if (!isLoading) {
            ...
            if (keyValue.getValue().equalsIgnoreCase(selectedDomain)) {
    ...
    public KeyValue getSelectedDomain(int position) {
