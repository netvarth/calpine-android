...
//        timelineView.setDayTextSize(a.getDimension(R.styleable.DatePickerTimeline_dayTextSize, getResources().getDimension(R.dimen.dayTextSize)));
    ...
    /**
     * go to a specific position of date recycler view
     *
     * @param difference_In_Days Array of Dates
     */
    public void goPosition(long difference_In_Days) {
        timelineView.getLayoutManager().scrollToPosition((int) difference_In_Days);
    }
}
