...
public class SharedPreference {
    ...
    private static SharedPreference mSharedPreferenceUtils;
    ...
    private SharedPreference(Context context) {
        mContext = context;
        mSharedPreferences = context.getSharedPreferences("YNWPref", Context.MODE_PRIVATE);
    ...
    public static synchronized SharedPreference getInstance(Context context) {
        ...
        if (mSharedPreferenceUtils == null) {
            mSharedPreferenceUtils = new SharedPreference(context.getApplicationContext());
        }
